...
private static final Scanner scanner = new Scanner(System.in);
  ...
  private static String[] nombres=new String[1];
  private static String[] objetos=new String[1];
  //Nos pidieron como maximo que se pudierna asignar 5 habilidades como maximo
  private static String[][] habilidades=new String[1][5];
  private static int[] nivelpersonaje=new int[1];
